          ...
          success: function (results) {
            ...
            if (that.data.length != results.length){    
              ...
              for (var i = 0; i < results.length; i++) {
                ...
                if (pic) {
                  jsonA = '{"title":"' + title + '","content":"' + content + '","id":"' + id + '","created_at":"' 
                  + created_at + '","attachment":"' + pic._url + '","dorm":"'+dorm +  '","price":"'+price + 
                 '","typetraIndex":"'+ typetraIndex + '","isDonate":"'+ isDonate + 
                  '","isdonCon":"'+ isdonCon +  '","college":"'+ colleges + '"}'
                }
                else {
                  jsonA = '{"title":"' + title + '","content":"' + content + '","id":"' + id + '","created_at":"' 
                  + created_at +  '","dorm":"'+ dorm +  '","price":"'+price + '","typetraIndex":"'+ typetraIndex +
                  '","isdonCon":"'+ isdonCon + '","college":"'+colleges +  '"}'
                }
